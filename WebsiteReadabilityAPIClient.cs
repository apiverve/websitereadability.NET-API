...
namespace APIVerve
{
    public class WebsiteReadabilityAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/websitereadability";
        ...
        public WebsiteReadabilityAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public WebsiteReadabilityAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WebsiteReadabilityQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(WebsiteReadabilityQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(WebsiteReadabilityQueryOptions options)
        {
